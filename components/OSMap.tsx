...
var tileLayer = L.tileLayer('https://core-sat.maps.yandex.net/tiles?l=sat&x={x}&y={y}&z={z}', { maxZoom: 19, opacity: 0.85 });
tileLayer.addTo(map);
...
` : `
var defCenter = [${initialCenter ? initialCenter.lat + ',' + initialCenter.lon : '55.7558,37.6173'}];
...
window.fitBoundsMap = fitBounds;
window.clearAllMap = clearAll;
</script>
</body>
</html>`;
...
const OSMap = forwardRef<any, Props>(({ points, currentLocation, mode }, ref) => {
